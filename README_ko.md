...
- **7가지 픽셀 애니메이션** — 대기(깜빡임), 슬픈 대기, 행복한 대기, 걷기, 잠자기(누워있기+ZZZ), 먹기, 기쁨(반짝이는 눈)
- **기분 따라 변하는 대기** — 행복도 <30 슬픈 표정 / 30-70 보통 / >70 웃는 표정
- **유한 상태 머신** — 정리된 상태 전이 로직
- **시스템 트레이** — 필요 없을 땐 트레이에 넣어둠
- **4개 언어** — 中文 / English / 日本語 / 한국어, 설정에서 전환
